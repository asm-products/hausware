...
class SlidesControllerTest < ActionController::TestCase
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post :create, slide: { caption: @slide.caption, order: @slide.order, picture: @slide.picture, slideshowable_id: @slide.slideshowable_id }
    end
  ...
  test "should update slide" do
    patch :update, id: @slide, slide: { caption: @slide.caption, order: @slide.order, picture: @slide.picture, slideshowable_id: @slide.slideshowable_id }
    assert_redirected_to slide_path(assigns(:slide))
  end
