...
class OrgsControllerTest < ActionController::TestCase
  ...
  test "should create org" do
    assert_difference('Org.count') do
      post :create, org: { email: @org.email, name: @org.name, owner_id: @org.owner_id, permalink: @org.permalink, phone: @org.phone }
    end
  ...
  test "should update org" do
    patch :update, id: @org, org: { email: @org.email, name: @org.name, owner_id: @org.owner_id, permalink: @org.permalink, phone: @org.phone }
    assert_redirected_to org_path(assigns(:org))
  end
